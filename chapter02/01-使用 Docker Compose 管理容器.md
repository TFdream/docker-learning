...
![image](https://user-images.githubusercontent.com/13992911/123249922-13a03880-d51c-11eb-86dd-2a1422a1f644.png)
...
```
需要注意的是，```docker-compose``` 命令默认会识别当前控制台所在目录内的 docker-compose.yml 文件，而会以这个目录的名字作为组装的应用项目的名称。
